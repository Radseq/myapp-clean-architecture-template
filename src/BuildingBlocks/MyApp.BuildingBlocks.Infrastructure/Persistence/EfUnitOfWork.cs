...
using MyApp.BuildingBlocks.Application.Common;
using MyApp.BuildingBlocks.Domain.Common;
using System.Text.RegularExpressions;

namespace MyApp.BuildingBlocks.Infrastructure.Persistence;

public class EfUnitOfWork<TDbContext>(TDbContext db, ILogger<EfUnitOfWork<TDbContext>> logger)
	...
	where TDbContext : DbContext
{
	...
	private sealed class EfUnitOfWorkTransaction(EfUnitOfWork<TDbContext> uow) : IUnitOfWorkTransaction
	{
